        ...
        <div className='flex h-full w-full items-center justify-between px-2'>
          <div className='flex h-full items-center'>
            ...
            <div className='hidden h-full gap-x-6 md:flex'>
              <Link href='/' className='flex h-full items-center hover:text-primary'>
                Trang chủ
              </Link>
              <Link href='/phim-le' className='flex h-full items-center hover:text-primary'>
                Phim lẻ
              </Link>
              <Link href='/phim-bo' className='flex h-full items-center hover:text-primary'>
                Phim bộ
              </Link>
                    ...
                    {genres &&
                      ...
                      genres.items.map(({ _id, name, slug }: Genres) => (
                        <Link key={_id} href={`/genres/${slug}`}>
                          <div className='whitespace-nowrap hover:text-primary'>{name}</div>
                        </Link>
                      ))}
                  </div>
                </div>
              ...
              <Link href='/favourite' className='flex h-full items-center hover:text-primary'>
                Yêu thích
              </Link>
            </div>
          </div>

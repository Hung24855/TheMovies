...
export default function FavoriteMovies() {
  ...
  return (
    <Fragment>{favoriteMovies.length > 0 ? <div className="mt-2 grid grid-cols-2 gap-2 pb-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
        {favoriteMovies.map(
      ...
      </div> : <div className="text-white text-3xl text-center">Không có phim nào trong danh sách</div>}</Fragment>
  )
}
